package com.example.inspiration.ui.adapter.animators
...
import com.example.inspiration.ui.adapter.core.*
...
fun RecyclerView.ViewHolder.animationWithDelayOffset(
    ...
    if (isEnableAnimation) {
        ...
        val delay = recyclerView?.calculateAnimationDelay(absoluteAdapterPosition, delayOffset)
        itemView.animation =
        ...
        recyclerView?.setTag(R.id.last_delay_animation_position, absoluteAdapterPosition)
